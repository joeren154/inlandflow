<?php
session_start();
if(isset($_SESSION['type_of_user']) && $_SESSION['type_of_user'] == 'Municipal') {
...
<head>
    ...
    <title>Municipal Login - InlandFlow</title>
...
<body class="flex items-center justify-center p-4">
    <div class="container max-w-md mx-auto">
        ...
        <div class="login-container p-8 shadow-2xl">
            <div class="text-center mb-8">
                <div class="w-20 h-20 bg-gradient-to-r from-teal-600 to-green-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <i class="bi bi-shield-check text-4xl text-white"></i>
                </div>
                <h2 class="text-2xl font-bold text-slate-800">Municipal Login</h2>
                <p class="text-slate-500 text-sm mt-1">Access Municipal Administrator Dashboard</p>
            </div>
            ...
            <form id="municipalLoginForm">
                ...
                <button type="submit" class="btn-login w-full text-white">
                    <i class="bi bi-box-arrow-in-right me-2"></i> Login as Municipal
                </button>
            </form>
            
             <div class="mt-6 pt-4 border-t border-slate-200 text-center">
                <p class="text-slate-500 text-sm">Contact your Provincial Tourism office for login credentials</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $('#municipalLoginForm').on('submit', function(e) {
            e.preventDefault();
            ...
            $.post('../api/auth/municipal-auth.php', $(this).serialize(), function(response) {
