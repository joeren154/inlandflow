<?php
session_start();
if(isset($_SESSION['type_of_user']) && $_SESSION['type_of_user'] == 'Guest') {
...
<head>
    ...
    <title>Guest Login - InlandFlow</title>
...
<body class="flex items-center justify-center p-4">
    <div class="container max-w-md mx-auto">
        ...
        <div class="login-container p-8 shadow-2xl">
            <div class="text-center mb-8">
                ...
                <h2 class="text-2xl font-bold text-slate-800">Guest Login</h2>
                <p class="text-slate-500 text-sm mt-1">Access your account to book resorts</p>
            </div>
            ...
            <form id="guestLoginForm">
                ...
                <button type="submit" class="btn-login w-full text-white mb-3">
                    <i class="bi bi-box-arrow-in-right me-2"></i> Login as Guest
                </button>
                
                <button type="button" onclick="window.location.href='guest-register.php'" class="btn-register w-full text-white">
                    <i class="bi bi-person-plus me-2"></i> Create New Account
                </button>
            </form>
            
            <div class="mt-6 pt-4 border-t border-slate-200 text-center">
                <p class="text-slate-500 text-sm">Don't have an account? <a href="guest-register.php" class="text-blue-600 font-semibold">Sign up here</a></p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $('#guestLoginForm').on('submit', function(e) {
            ...
            $.post('../api/auth/guest-auth.php', $(this).serialize(), function(response) {
