...
$iddelete = isset($_POST['add_on_amenity_id']) ? (int)$_POST['add_on_amenity_id'] : 0;

if (!$iddelete) {
    echo "Error: Missing add_on_amenity_id";
    exit;
}
...
$deleteDetails = $db->prepare("DELETE FROM tb_add_on_amenities WHERE add_on_amenity_id = ?");
...
echo "OK|" . number_format($newTotal ?? 0, 2);
?>